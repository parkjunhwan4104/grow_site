...
async function checkDupleLoginId(){
    ...
    await fetch("http://localhost:8080/members/check/id?loginId=" +loginId)
    .then(
...
async function checkDupleNickName(){
        ...
        await fetch("http://localhost:8080/members/check/nickName?nickName=" +nickName)
        .then(
...
async function checkDupleEmail(){
        ...
        await fetch("http://localhost:8080/members/check/email?email=" +email)
        .then(
